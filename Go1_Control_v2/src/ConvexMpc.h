...
public:
    ...
    void calculate_B_mat_c(double robot_mass, const Eigen::Matrix3d &go1_lumped_inertia, Eigen::Matrix3d root_rot_mat,
                           Eigen::Matrix<double, 3, NUM_LEG> foot_pos);

    void state_space_discretization(double dt);

    void calculate_qp_mats(Go1ControlStates &state);
