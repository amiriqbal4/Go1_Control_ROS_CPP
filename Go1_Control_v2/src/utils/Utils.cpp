...
/*** Edited by Amir 03/02/23 (modified some parameters)***/
//
                                   ...
                                   double terrain_pitch_angle = 0)
{
    ...
    std::vector<double> bezierY{foot_pos_start(1),
                                foot_pos_start(1), //foot_pos_start
                                foot_pos_final(1), //foot_pos_final
                                foot_pos_final(1),
                                foot_pos_final(1)};
    ...
    std::vector<double> bezierZ{foot_pos_start(2),
                                foot_pos_start(2), //foot_pos_start(2)
                                foot_pos_start(2), //foot_pos_final(2)
                                foot_pos_final(2),
                                foot_pos_final(2)};
    bezierZ[1] += FOOT_SWING_CLEARANCE1;
    bezierZ[2] += FOOT_SWING_CLEARANCE2 + 0.3*sin(terrain_pitch_angle);
    // bezierZ[3] += FOOT_SWING_CLEARANCE2 + 0.5*sin(terrain_pitch_angle);
